...
public class Homework1 extends DBTest {
    ...
    void selectAllArtistsWithMoreThanOneAlbum(){
        List<Map<String, Object>> results = executeSQL("SELECT artists.Name, Count(DISTINCT albums.albumId) as Albums From albums Join artists on albums.ArtistId = artists.ArtistId GROUP BY albums.ArtistId HAVING Albums > 1;");
